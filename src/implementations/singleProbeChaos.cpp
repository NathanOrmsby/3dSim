...
void chaosRK4(Planet *e, Planet *s, Probe *jw, double dt, int NUMPOINTS)
{
	...
	copyPlanet(&k2Planets[0], *e); copyPlanet(&k2Planets[1], *s); copyPlanet(&k3Planets[0], *e); copyPlanet(&k3Planets[1], *s); copyPlanet(&k4Planets[0], *e); copyPlanet(&k4Planets[1], *s);
...
void chaosCalcForce(Planet e, Planet s, Probe jw, double *accels, int NUMPOINTS)
{
	...
	// std::cout << "Sun earth distance is: " << magr21 << std::endl;
	std::cout << "Sun on earth acceleration is: " << accels[0] << " " << accels[2] << std::endl;
	std::cout << "Earth: mass: " << e.m << " Sun: mass: " << s.m << std::endl;
	std::cout << "Dist: " << magr21 << std::endl;
	...
	std::cout << "Sun on james webb telescope is: " << gravity31 << std::endl;
	...
	std::cout << "Earth on james webb telescope is: " << gravity32 << std::endl;
	std::cout << "Net on james webb telescope is: " << accels[3] << " " << accels[5] << std::endl;
...
{
	std::string fileName1 = "D:\\3dsim\\singleChaosData\\probe.csv";
	std::string fileName2 = "D:\\3dsim\\singleChaosData\\perturbations.csv";
	std::ofstream file1;
	std::ofstream file2;
